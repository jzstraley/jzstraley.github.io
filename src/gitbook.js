                        ...
                        for (var n, r, o = [], i = 0, s = e.length; i < s; i++)
                            (r = e[i]),
                                r.style &&
                                    ((n = r.style.display),
                                    t
                                        ? ("none" === n && ((o[i] = Fe.get(r, "display") || null), o[i] || (r.style.display = "")), "" === r.style.display && Be(r) && (o[i] = g(r)))
                        ...
                        for (var i, s, a, u, c, l, f = t.createDocumentFragment(), p = [], h = 0, d = e.length; h < d; h++)
                            if (((i = e[h]), i || 0 === i))
                                if ("object" === de.type(i)) de.merge(p, i.nodeType ? [i] : i);
                                    ...
                                    for (s = s || f.appendChild(t.createElement("div")), a = (Xe.exec(i) || ["", ""])[1].toLowerCase(), u = Ge[a] || Ge._default, s.innerHTML = u[1] + de.htmlPrefilter(i) + u[2], l = u[0]; l--; )
                                        s = s.lastChild;
                        ...
                        return (
                            ...
                            n &&
                                ...
                                !pe.pixelMarginRight() &&
                                    st.test(s) &&
                                    it.test(t) &&
                                    ((r = a.width), (o = a.minWidth), (i = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = r), (a.minWidth = o), (a.maxWidth = i))),
                            void 0 !== s ? s + "" : s
                        );
                    }
                    function O(e, t) {
                                        ...
                                        (n = s[t]),
                                            ...
                                            s !== r &&
                                                (c && r && (de.isPlainObject(r) || (o = de.isArray(r)))
                                                    ? (o ? ((o = !1), (i = n && de.isArray(n) ? n : [])) : (i = n && de.isPlainObject(n) ? n : {}), (s[t] = de.extend(c, i, r)))
                                                    : void 0 !== r && (s[t] = r));
                            return s;
                        }),
                        de.extend({
                            ...
                            if (u && c.nodeType && !("click" === e.type && e.button >= 1))
                                for (; c !== this; c = c.parentNode || this)
                                    if (1 === c.nodeType && ("click" !== e.type || c.disabled !== !0)) {
                                        for (i = [], s = {}, n = 0; n < u; n++)
                                            (r = t[n]), (o = r.selector + " "), void 0 === s[o] && (s[o] = r.needsContext ? de(o, this).index(c) > -1 : de.find(o, this, null, [c]).length), s[o] && i.push(r);
